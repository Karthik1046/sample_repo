      ...
      <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-gray-400 hover:bg-primary-500 hover:text-white transition-all duration-300"
              >
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <motion.button
            ...
            onClick={scrollToTop}
            className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-lg text-gray-400 hover:bg-primary-500 hover:text-white transition-all duration-300"
            whileHover={{ y: -2 }}
          >
            <ArrowUp size={16} />
